...
- `assets/line-shaft-floor-machine-shop-core77.png`: image id `549455` from Core77, `How Did Factories Get Power to Their Machines Before Electricity?` The article uses it to illustrate overhead line shafts and belts distributing power to factory machines. The downloaded URL has a `.jpg` suffix but the file bytes are PNG, so the local asset uses `.png`. <https://www.core77.com/posts/58982/how-did-factories-get-power-to-their-machines-before-electricity>
